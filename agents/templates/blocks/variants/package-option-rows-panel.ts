...
/* 흰 패널 */
.porp-panel{background:var(--paper);border-radius:20px;overflow:hidden;padding:0 0 4px}
/* 각 옵션 행 */
...
/* 이미지 슬롯 */
.porp-img{width:140px;height:164px;object-fit:cover;border-radius:6px;display:block;flex-shrink:0}
.porp-img.ph{width:140px;height:164px;border-radius:6px;background:#ebebeb;border:none;color:#aaa;font-size:12px}
/* 오른쪽 텍스트 블록 */
.porp-info{padding-left:20px;display:flex;flex-direction:column;gap:8px}
/* 옵션번호 배지 — 아웃라인 박스 */
.porp-opt{display:inline-block;border:1.5px solid var(--ink);border-radius:5px;padding:2px 10px;font-size:13px;font-weight:700;color:var(--ink);letter-spacing:.04em;width:fit-content}
/* 제품명 */
