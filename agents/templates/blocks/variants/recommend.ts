...
export const recommendDark = defineBlock<Data>({
  ...
  schema,
  css: `
.rec{position:relative;background:var(--brand);color:#F3E9DA;text-align:center;padding:56px 56px 64px;overflow:hidden}
.rec-float{width:96px;height:96px;border-radius:18px;object-fit:cover;margin:0 auto 22px;box-shadow:0 16px 30px rgba(0,0,0,.4);transform:rotate(-6deg)}
...
.rec-fig{position:relative;margin:34px auto 0;width:600px;overflow:hidden;border-radius:22px}
