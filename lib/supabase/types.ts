...
export interface Database {
  public: {
    Tables: {
      ...
      projects: {
        Row: { id: string; client_id: string; planner_id: string | null; designer_id: string | null; status: string; company_name: string; homepage_url: string | null; detail_page_url: string | null; product_highlights: string | null; product_name: string | null; product_description: string | null; selling_points: Json | null; reference_notes: string | null; platform_id: string | null; category: string | null; category_id: string | null; brand_name: string | null; target_audience: Json | null; design_preference: string | null; contact_name: string | null; contact_phone: string | null; contact_email: string | null; full_ingredients: string | null; shipping_info: string | null; return_policy: string | null; cs_info: string | null; due_date: string | null; product_received_at: string | null; intake_approved_at: string | null; revision_count: number; client_viewed_at: string | null; client_delivered_at: string | null; tags: Json; created_at: string; updated_at: string }
